...
class SceneNode {
    ...
    draw(mvp, modelView, normalMatrix, modelMatrix) {
        ...
        var sphere; //just a variable to go through all the objects in our solar system  
        for(sphere of this.children) {
            sphere.draw(transformedMvp, transformedModelView, transformedNormals, transformedModel);
        }
    }
}